...
(function (global) {
  ...
  const COURSES = {
    ...
    get list() {
      // 固定展示顺序
      const ORDER = ['intro', 'limit', 'limit-laws', 'derivative', 'derivative-rules', 'mean-value-theorem', 'lhopital', 'convexity', 'integral', 'indefinite-integral', 'integral-applications', 'taylor', 'series-basics', 'positive-series', 'fourier-series', 'ode', 'partial-derivative', 'gradient', 'double-integral'];
